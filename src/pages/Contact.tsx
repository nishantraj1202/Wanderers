...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Phone',
      details: ['+91 98765 43212', '+91 87654 32109'],
  ...
  {contactInfo.map((item, index) => (
    <div
      key={index}
      className="bg-blue-50 border-4 border-black shadow-[6px_6px_0px_#000] p-6 text-center rounded-none transition-transform duration-300 hover:translate-x-1 hover:translate-y-1 animate-slide-up"
      style={{ animationDelay: `${index * 0.1}s` }}
    >
      <div className="inline-flex items-center justify-center w-16 h-16 bg-yellow-300 border-4 border-black mb-4 shadow-[3px_3px_0px_#000]">
        <item.icon className="h-8 w-8 text-black" />
      </div>

      <h3 className="font-mono font-extrabold text-lg text-black underline underline-offset-4 mb-3">
        {item.title}
      </h3>

      <div className="space-y-1 mb-3">
        {item.details.map((detail, idx) => (
          <p key={idx} className="font-mono text-black font-medium">
            {detail}
          </p>
        ))}
      </div>

      <p className="font-mono text-sm bg-white border-2 border-black px-3 py-2 shadow-[2px_2px_0px_#000] text-black">
        {item.description}
      </p>
    </div>
  ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="bg-blue-200 border-4 border-black shadow-[6px_6px_0px_#000] p-8 rounded-none">
            <h2 className="font-poppins font-extrabold text-3xl text-black mb-6 underline underline-offset-4">
              Send us a Message
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block font-mono font-bold text-black mb-2">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 border-4 border-black bg-white font-mono shadow-[4px_4px_0px_#000] focus:outline-none"
                    placeholder="Your full name"
                  />
                </div>

                <div>
                  <label htmlFor="email" className="block font-mono font-bold text-black mb-2">
                    Email Address *
                  </label>
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="phone" className="block font-mono font-bold text-black mb-2">
                    Phone Number
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="subject" className="block font-mono font-bold text-black mb-2">
                    Subject *
                  </label>
                  <select
                    id="subject"
              ...
              <div>
                <label htmlFor="message" className="block font-mono font-bold text-black mb-2">
                  Message *
                </label>
                <textarea
                  id="message"
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border-4 border-black bg-white font-mono shadow-[4px_4px_0px_#000] focus:outline-none resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-black text-yellow-300 py-4 px-6 border-4 border-black shadow-[4px_4px_0px_#000] font-mono font-bold text-lg transition-transform duration-200 hover:translate-x-[2px] hover:translate-y-[2px] flex items-center justify-center"
              >
          ...
          <div className="space-y-6">
            ...
            {/* WhatsApp Support */}
            <div className="bg-lime-200 border-4 border-black p-6 shadow-[6px_6px_0px_#000] rounded-none animate-slide-in-right">
              <div className="flex items-center mb-4">
                <MessageCircle className="h-8 w-8 text-black mr-3" />
                <h3 className="font-mono font-extrabold text-xl text-black underline underline-offset-4">
                  WhatsApp Support
                </h3>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center bg-black text-lime-300 px-6 py-3 border-4 border-black shadow-[4px_4px_0px_#000] font-mono font-bold text-sm hover:translate-x-[2px] hover:translate-y-[2px] transition-transform duration-150"
              >
            ...
            {/* Business Hours */}
            <div className="bg-orange-200 border-4 border-black p-6 shadow-[6px_6px_0px_#000] rounded-none animate-slide-in-right">
              <div className="flex items-center mb-4">
              ...
              <div className="space-y-2 font-mono text-black text-sm">
              ...
              <p className="font-mono text-xs text-black mt-4 bg-white border-2 border-black px-4 py-2 shadow-[3px_3px_0px_#000]">
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            <h2 className="font-poppins font-extrabold text-4xl text-black mb-4 border-4 border-black inline-block px-4 py-2 bg-yellow-300 shadow-[4px_4px_0px_#000]">
              Frequently Asked Questions
            </h2>
            <p className="font-mono text-lg text-black bg-white px-4 py-2 border-2 border-black inline-block shadow-[2px_2px_0px_#000]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="bg-gray-50 border-4 border-black-300 rounded-none shadow-[6px_6px_0px_#000] p-6 transition-transform duration-300 hover:translate-x-1 hover:translate-y-1"
                style={{ animation: 'slide-up 0.5s ease forwards', animationDelay: `${index * 0.1}s` }}
              >
                <h3 className="font-bold text-xl text-black mb-2 font-poppins underline underline-offset-4">
                  {faq.question}
                </h3>
                <p className="font-mono text-black text-base leading-relaxed">
                  {faq.answer}
                </p>
              </div>
            ))}
