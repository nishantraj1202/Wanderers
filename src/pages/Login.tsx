      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 animate-slide-up">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm font-roboto text-gray-700">
                  Remember me
                </label>
              </div>
              <div className="text-sm">
                <a href="#" className="font-roboto text-earth-600 hover:text-earth-700 transition-colors">
                  Forgot password?
                </a>
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500 font-roboto">Or continue with</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="font-roboto text-gray-600">
              ...
              <Link to="/register" className="font-medium text-earth-600 hover:text-earth-700 transition-colors">
                Sign up here
              </Link>
            </p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 animate-slide-up">
          <h3 className="font-poppins font-semibold text-lg text-earth-800 mb-4 text-center">
            Why Join Wanderers Club?
          </h3>
          <div className="space-y-3">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-earth-600 rounded-full mr-3"></div>
              <span className="font-roboto text-gray-700">Exclusive member discounts</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-earth-600 rounded-full mr-3"></div>
              <span className="font-roboto text-gray-700">Personalized trip recommendations</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-earth-600 rounded-full mr-3"></div>
              <span className="font-roboto text-gray-700">Easy booking management</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-earth-600 rounded-full mr-3"></div>
              <span className="font-roboto text-gray-700">24/7 travel support</span>
            </div>
          </div>
        </div>
      </div>
